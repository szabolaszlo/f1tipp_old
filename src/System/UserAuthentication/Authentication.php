...
namespace System\UserAuthentication;

use Application\HttpProtocol\ICookie;
use Doctrine\ORM\EntityManagerInterface;
use Entity\User;
use Entity\UserAuthentication;

/**
 * Class Authentication
 * @package System\User\Authentication
 */
class Authentication
{
    ...
    public function __construct(EntityManagerInterface $entityManager, ICookie $cookie)
    {
        ...
        $this->cookie = $cookie;
        $this->userAuthEnt = $this->entityManager->getRepository('Entity\UserAuthentication');
    }
