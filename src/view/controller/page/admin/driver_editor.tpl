    ...
    {% if not error %}
        {% if drivers %}
            ...
            <div class="pull-right" style="padding: 15px">
                <strong>{{ language.get('admin_driver_editor_enabeld_driver') }} {{ enabledDrivers }}</strong>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-center">{{ language.get('admin_driver_editor_driver_short') }}</th>
                            <th class="text-center">{{ language.get('admin_driver_editor_driver_point') }}</th>
                            <th class="text-center">{{ language.get('admin_driver_editor_driver_status') }}</th>
                        </tr>
                        </thead>
