...
namespace Controller\Page\WeekendPoints\ResultCollector\CollectedPointConverter;
 ...
 * @package Controller\Page\WeekendPoints\ResultCollector\CollectedPointConverter
 */
class CollectedPointConverter
{
    /**
