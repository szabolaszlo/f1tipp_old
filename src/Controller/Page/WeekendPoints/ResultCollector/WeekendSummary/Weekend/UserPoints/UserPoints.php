...
namespace Controller\Page\WeekendPoints\ResultCollector\WeekendSummary\Weekend\UserPoints;

use Entity\User;

/**
 * Class UserPoints
 * @package Controller\Page\WeekendPoints\ResultCollector\WeekendSummary\Weekend\UserPoints
 */
class UserPoints
{
    /**
