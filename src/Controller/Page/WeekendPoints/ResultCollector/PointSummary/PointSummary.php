...
namespace Controller\Page\WeekendPoints\ResultCollector\PointSummary;

use Controller\Page\WeekendPoints\ResultCollector\PointSummary\UserPoint\UserPoint;
use Doctrine\ORM\EntityManagerInterface;
use Entity\User;

/**
 * Class PointSummary
 * @package Controller\Page\WeekendPoints\ResultCollector\PointSummary
 */
class PointSummary
{
    /**
